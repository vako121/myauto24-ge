...
export const modelsByMake: Record<string, string[]> = {
  ...
  Kia: ["Sportage", "Sorento", "Optima", "Rio", "Cerato"],
...
Opel: ["Astra", "Vectra", "Insignia", "Corsa", "Zafira"],
...
Suzuki: ["Swift", "Vitara", "Jimny", "SX4", "Grand Vitara"],
Infiniti: ["G35", "G37", "Q50", "Q60", "FX35"],
Acura: ["TL", "TLX", "MDX", "RDX", "ILX"],
Cadillac: ["CTS", "ATS", "Escalade", "XT5", "XT6"],
GMC: ["Terrain", "Acadia", "Yukon", "Sierra", "Canyon"],
Dodge: ["Charger", "Challenger", "Durango", "Journey", "Ram"],
Chrysler: ["300", "200", "Pacifica", "Voyager", "Sebring"],
Ram: ["1500", "2500", "3500", "ProMaster", "TRX"],
Lincoln: ["MKZ", "Navigator", "Aviator", "Corsair", "Nautilus"],
Mini: ["Cooper", "Clubman", "Countryman", "Paceman", "Roadster"],
Jaguar: ["XF", "XE", "F-Pace", "E-Pace", "XJ"],
"Alfa Romeo": ["Giulia", "Stelvio", "159", "Brera", "Mito"],
Fiat: ["500", "Panda", "Tipo", "Punto", "Doblo"],
Peugeot: ["206", "208", "308", "3008", "508"],
Renault: ["Megane", "Clio", "Laguna", "Kadjar", "Duster"],
Citroen: ["C3", "C4", "C5", "Berlingo", "DS3"],
Skoda: ["Octavia", "Superb", "Kodiaq", "Fabia", "Rapid"],
Seat: ["Leon", "Ibiza", "Ateca", "Toledo", "Altea"],
